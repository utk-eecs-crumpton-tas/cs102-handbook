...
```bash
curl -L https://tinyurl.com/7ze97yex --output Makefile
```
...
| Test No. | Command                             | Input      | Output      | Manipulation | Expected Output | Comparison Image |
| -------- | ----------------------------------- | ---------- | ----------- | ------------ | --------------- | ---------------- |
| 1        | ./lab11 gs/bee.ppm gs/outI.ppm I    | gs/bee.ppm | gs/outI.ppm | I (invert)   | gs/outI.ppm     | gs/solI.ppm      |
| 2        | ./lab11 gs/bee.ppm gs/outX.ppm X    | gs/bee.ppm | gs/outX.ppm | X (flip x)   | gs/outX.ppm     | gs/solX.ppm      |
| 3        | ./lab11 gs/bee.ppm gs/outY.ppm Y    | gs/bee.ppm | gs/outY.ppm | Y (flip y)   | gs/outY.ppm     | gs/solY.ppm      |
| 4        | ./lab11 gs/bee.ppm - gs/outI.ppm I  | gs/bee.ppm | stdout      | I (invert)   | gs/outI.ppm     | gs/solI.ppm      |
| 5        | ./lab11 gs/bee.ppm - gs/outX.ppm X  | gs/bee.ppm | stdout      | X (flip x)   | gs/outX.ppm     | gs/solX.ppm      |
| 6        | ./lab11 gs/bee.ppm - gs/outY.ppm Y  | gs/bee.ppm | stdout      | Y (flip y)   | gs/outY.ppm     | gs/solY.ppm      |
| 7        | ./lab11 - gs/outI.ppm gs/outI.ppm I | stdin      | gs/outI.ppm | I (invert)   | gs/outI.ppm     | gs/solI.ppm      |
| 8        | ./lab11 - gs/outX.ppm gs/outX.ppm X | stdin      | gs/outX.ppm | X (flip x)   | gs/outX.ppm     | gs/solX.ppm      |
| 9        | ./lab11 - gs/outY.ppm gs/outY.ppm Y | stdin      | gs/outY.ppm | Y (flip y)   | gs/outY.ppm     | gs/solY.ppm      |
| 10       | ./lab11 - - I                       | stdin      | stdout      | I (invert)   | gs/outI.ppm     | gs/solI.ppm      |
| 11       | ./lab11 - - X                       | stdin      | stdout      | X (flip x)   | gs/outX.ppm     | gs/solX.ppm      |
| 12       | ./lab11 - - Y                       | stdin      | stdout      | Y (flip y)   | gs/outY.ppm     | gs/solY.ppm      |
| 13       | ./lab11 - -                         | stdin      | stdout      | none         | gs/bee.ppm      | gs/bee.ppm       |

#### make tests-nf

The same as `make tests`, but it doesn't exit if a test fails. This is useful if you want to see all of the tests that fail, instead of just the first one.
