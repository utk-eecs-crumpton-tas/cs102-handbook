...
If you're getting something like "command 'make' not found", then make sure you followed the instructions in [Setup & Downloading Makefile](#setup--downloading-makefile) exactly.
