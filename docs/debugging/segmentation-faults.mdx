...
If you're not on the lab machines, you'll need to install `gdb` yourself if you haven't already. You can find `gdb` installation instructions in <LinkWithIcon to="/docs/general/info?os=windows#installing-gdb" text="this guide" />.
