...
:::danger
If your code does not compile on a hydra or telsa lab machine and we cannot run it, it will be graded as a zero. You **must** make sure your code compiles on one of the lab machines before submitting it.
:::
